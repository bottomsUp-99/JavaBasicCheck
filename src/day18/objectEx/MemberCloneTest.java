...
public class MemberCloneTest {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.printf("Member1 hashcode : %s, address1 hashcode : %s\n", member1,
          member1.getAddr());
      System.out.printf("Member2 hashcode : %s, address2 hashcode : %s\n", member2,
          member2.getAddr());
      System.out.printf("address1 hashcode : %s, address1 hashcode : %s\n", address1,
          address1.getAddr());
      System.out.printf("address2 hashcode : %s, address2 hashcode : %s\n", address2,
          address2.getAddr());
